...
describe('Internal function', () => {
  ...
  describe(tryGetFunctionDef.name, () => {
    ...
    it('Should return a new FunctionDef when given a template function', () => {
      const pointTempDef: FunctionDef = {
        name: 'point-temp',
        argNames: ['p'],
        isTemplate: true,
        // ((posn-x p) ... (posn-y p))
    ...
    it('Should return a new FunctionDef for the "my-animate" example', () => {
      const myAnimateDef: FunctionDef = {
        name: 'my-animate',
        argNames: ['f-to-draw'],
        isTemplate: false,
...
describe('Linter class', () => {
  ...
  describe('Example 2 (locals)', () => {
    ...
    it('Should generate a warning for the local definition in "double-squares"', () => {
      const doubleSquaresExpected: FunctionDesign = {
        kind: 'FunctionDesign',
        name: 'double-squares',
        purposeLines: 1,
        tests: 2,
    ...
    it('Should generate a warning for the local definition in "usd-to-euro"', () => {
      const usdToEuroExpected: FunctionDesign = {
        kind: 'FunctionDesign',
        name: 'usd-to-euro',
        purposeLines: 2,
        tests: 2,
    ...
    it('Should generate no warnings for the local definition in "slope"', () => {
      const slopeExpected: FunctionDesign = {
        kind: 'FunctionDesign',
        name: 'slope',
        purposeLines: 1,
        tests: 2,
